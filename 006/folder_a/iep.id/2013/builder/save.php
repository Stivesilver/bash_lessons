<?php
	...
	if (!file_exists($filename)) {
		...
		DBImportRecord::factory('webset.std_iep', 'siepmrefid')
			...
			->set('stdiepmeetingdt', $student->getDate('stdiepmeetingdt'))
			->set('stdenrolldt', $student->getDate('stdenrolldt'))
			->set('stdcmpltdt', $student->getDate('stdcmpltdt'))
			->set('stdevaldt', $student->getDate('stdevaldt'))
			->set('stdtriennialdt', $student->getDate('stdtriennialdt'))
