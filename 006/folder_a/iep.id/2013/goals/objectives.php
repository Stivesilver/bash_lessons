<?php
	...
	$list->addURL = CoreUtils::getURL('objectives_add.php', array('dskey' => $dskey, 'goal' => $goal));
    $list->editURL = CoreUtils::getURL('objectives_add.php', array('dskey' => $dskey, 'goal' => $goal));
