<?PHP
    ...
    if ($IEPType > 0) {
        IDEAStudentRegistry::saveStdKey($tsRefID, 'id_iep', 'builder_reporttype', io::get('idReportType'), 0);
    ...
    $doc_id = IDEAStudentRegistry::readStdKey($tsRefID, 'id_iep', 'builder_reporttype', 0);
    $title = "ELIGIBILITY REPORT";
    $stitle = "Eligibility Report";
    ...
    if (io::get('str') != '') {
        ...
        $content .= '<line><section width="100%">This ' . $stitle . ' is an: <field>' . $IEPType . '</field></section></line>';
