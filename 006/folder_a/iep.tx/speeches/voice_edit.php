<?php
	...
	$SQL = "INSERT INTO webset_tx.std_speech_voice (stdrefid, iepyear)
            SELECT $tsRefID, $stdIEPYear
             WHERE NOT EXISTS (SELECT 1 FROM webset_tx.std_speech_voice
	...
	$edit->setSourceTable('webset_tx.std_speech_voice', 'refid');
