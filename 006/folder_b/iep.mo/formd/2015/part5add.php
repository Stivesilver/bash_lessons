<?php
	...
	$edit->title = 'Add/Edit Form D-Part 5:  State Accommodations for ACCESS FOR ELLS';
    ...
    $SQL = $RefID > 0 ? "
                        SELECT accrefid,
                               COALESCE(catname || ': ', '') || accname
                          FROM webset.statedef_aa_wida_acc acc
                               LEFT OUTER JOIN webset.statedef_aa_wida_cat cat ON catrefid = acccat
	...
	$edit->finishURL = CoreUtils::getURL('part5.php', array('dskey'=>$dskey));
	$edit->cancelURL = CoreUtils::getURL('part5.php', array('dskey'=>$dskey));
