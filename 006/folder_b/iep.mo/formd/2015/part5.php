<?php
	...
	$list->title = 'Form D – Part 5: ACCESS For ELLs 2.0';
	...
	$list->addURL = CoreUtils::getURL('part5add.php', array('dskey' => $dskey));
	$list->editURL = CoreUtils::getURL('part5add.php', array('dskey' => $dskey));
