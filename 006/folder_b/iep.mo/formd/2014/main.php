<?php
    ...
    $tabs = new UITabs('tabs');
        ...
        $tabs->addTab('MAP Accommodations (Part 2)')->url(CoreUtils::getURL('part2.php', array('dskey' => $dskey, 'nexttab' => '3')));
        $tabs->addTab('ACT (Part 3)')->url(CoreUtils::getURL('part3.php', array_merge($_GET, array('nexttab' => '4'))));
        $tabs->addTab('MAP-A (Part 4)')->url(CoreUtils::getURL('part4.php', array_merge($_GET, array('nexttab' => '5'))));
