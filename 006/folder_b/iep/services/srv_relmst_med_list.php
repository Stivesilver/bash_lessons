<?php
    ...
    $list->addColumn('Period')->dataCallback('clearNAservice');
    ...
    $list->addURL = CoreUtils::getURL('srv_relmst_med_add.php', array('dskey' => $dskey));
    $list->editURL = CoreUtils::getURL('srv_relmst_med_add.php', array('dskey' => $dskey));
