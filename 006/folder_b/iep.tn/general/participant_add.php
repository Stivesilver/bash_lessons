<?php
	...
	$edit->addControl(FFSwitchYN::factory('Fully Agree'))
		->sqlField('participantagree');

	$edit->addControl('Area(s) of Concerns/Comments', 'textarea')
		->sqlField('participantcomment');
	...
	$edit->finishURL = CoreUtils::getURL('./participant_list.php', array('dskey' => $dskey));
	$edit->cancelURL = CoreUtils::getURL('./participant_list.php', array('dskey' => $dskey));
