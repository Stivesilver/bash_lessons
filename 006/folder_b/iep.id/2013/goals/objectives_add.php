<?php
	...
	$edit->addControl('Objective/Benchmark', 'textarea')
		...
		->css('height', '50px')
		->autoHeight(true)
		->help('Required if student takes the ISAT-Alt');
	...
	$edit->finishURL = CoreUtils::getURL('objectives.php', array('dskey' => $dskey, 'goal' => $goal));
	$edit->cancelURL = CoreUtils::getURL('objectives.php', array('dskey' => $dskey, 'goal' => $goal));
