<?PHP
	...
	if (io::get('str') != '') {
		...
		$content .= '<line><section width="100%">This ' . $stitle . ' is an: <field>' . io::get('idReportType') . '</field></section></line>';
	...
	//io::err("<textarea>" .  SystemCore::$tempPhysicalRoot . "/" . $xml_file . "</textarea>");
