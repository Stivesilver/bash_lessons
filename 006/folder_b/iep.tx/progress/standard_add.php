<?php
    ...
    $edit->title = 'Add/Edit Standards Based Goals Progress';
    
    $edit->setSourceTable('webset_tx.std_sb_progress', 'sprrefid');    
    ...
    $edit->finishURL = CoreUtils::getURL('standard_main.php', array('dskey'=>$dskey, 'ESY'=>$esy, 'siymrefid'=>$siymrefid)); 
    $edit->cancelURL = CoreUtils::getURL('standard_main.php', array('dskey'=>$dskey, 'ESY'=>$esy, 'siymrefid'=>$siymrefid)); 
