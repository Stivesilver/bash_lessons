    ...
    if (io::get('RefID') == '') {
        ...
        $list->SQL = "
            SELECT dtsrefid,
              ...
              FROM webset.disdef_services_sped
        ...
        $list->addURL = 'spedservice.php';
        $list->editURL = 'spedservice.php';

        $list->addButton(
            FFIDEAExportButton::factory()
                ->setTable('webset.disdef_services_sped')
        ...
        $edit->setSourceTable('webset.disdef_services_sped', 'dtsrefid');
        ...
        $edit->finishURL = 'spedservice.php';
        $edit->cancelURL = 'spedservice.php';
