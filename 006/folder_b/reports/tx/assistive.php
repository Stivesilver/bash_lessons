<?php
	...
	$list = new listClass();
	$list->title = 'Assistive Technology';
	...
	$list->addSearchField(FFSwitchYN::factory('Assistive Technology'))->sqlField('regchk.srkeydata');
	...
	$list->addColumn('Assistive Technology')->sqlField('rchk')->type('switch');
