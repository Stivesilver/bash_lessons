<?PHP
	...
	require_once(SystemCore::$physicalRoot . "/applications/webset/iep.ut/documentation/builder_core/IEPDates.php");
	require_once(SystemCore::$physicalRoot . "/applications/webset/iep.ut/documentation/builder_core/XMLTemplates.php");
	...
	//TOP MARGIN
	$std_demo = std_demo_simple($tsRefID);
	...
	$content = '<doc headerleft="' . $leftHeader . '" headerright="' . $rightHeader . '" headerstart="1" headersize="8">';
